...
const styles = StyleService.create({
    ...
    batchCountCircle: {
        ...
        borderWidth: 1,
        backgroundColor: '$lightBlue',
        borderRadius: AppSizes.scale(15),
        minWidth: AppSizes.scale(20),
        paddingHorizontal: AppSizes.scale(5),
    ...
    iconBatchSigners: {
        tintColor: '$orange',
        marginLeft: AppSizes.scale(1),
        marginTop: AppSizes.scale(1),
        marginRight: AppSizes.scale(2),
    },
    batchIconContainer: {
        borderColor: '$blue',
        borderWidth: 1,
        ...
        paddingHorizontal: AppSizes.scale(2),
        justifyContent: 'center',
        // paddingRight: AppSizes.scale(5),
        position: 'absolute',
        top: AppSizes.scale(-2),
        left: AppSizes.scale(-2),
    },
    batchIconText: {
        fontFamily: AppFonts.base.family,
        fontSize: AppFonts.subtext.size * 0.5,
        color: '$blue',
        letterSpacing: -0.3,
        textAlign: 'center',
    },
